...
Function DesktopWidth:Int()
	Return TGLFWMonitor.GetPrimaryMonitor().GetVideoMode().width
End Function
	
Function DesktopHeight:Int()
	Return TGLFWMonitor.GetPrimaryMonitor().GetVideoMode().height
End Function
	
Function DesktopDepth:Int()
	Return TGLFWMonitor.GetPrimaryMonitor().GetVideoMode().redBits*4
End Function
	
Function DesktopHertz:Int()
	Return TGLFWMonitor.GetPrimaryMonitor().GetVideoMode().refreshRate
End Function
